    ...
    <div>
      ...
      >
        ...
        <div className="min-w-0 flex-auto pb-8">
          ...
          {description ? (
            <div className="mx-auto mt-18 w-max max-w-full text-sm text-muted md:mx-0 md:mt-26 text-center md:text-start">
              {description}
            </div>
          ) : null}

          {footer ? <div className="mt-24 mx-auto">{footer}</div> : null}
        </div>
      </header>
